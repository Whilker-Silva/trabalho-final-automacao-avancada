...
/**
 * Classe {@code BotPayment} representa um cliente automatizado que interage com
 * o sistema bancário
 * para realizar transferências via mensagens JSON.
 * <p>
 * Herda de {@code Cliente} que é uma {@code Thread} e encapsula uma conta
 * corrente que é criada no momento da instância.
 * </p>
 */
public class BotPayment extends Cliente {
     ...
     * A transação é serializada em JSON e enviada por meio do método
     * {@code enviaMensagem}.
     *
