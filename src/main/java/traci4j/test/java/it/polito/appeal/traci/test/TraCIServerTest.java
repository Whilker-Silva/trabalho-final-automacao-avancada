...
import traci4j.src.java.it.polito.appeal.traci.protocol.Command;
import traci4j.src.java.it.polito.appeal.traci.protocol.Constants;
import traci4j.src.java.it.polito.appeal.traci.protocol.RequestMessage;
import traci4j.src.java.it.polito.appeal.traci.protocol.ResponseContainer;
import traci4j.src.java.it.polito.appeal.traci.protocol.ResponseMessage;
...
public class TraCIServerTest {
    ...
    private static final Logger log = LoggerFactory.getLogger(TraCIServerTest.class);
