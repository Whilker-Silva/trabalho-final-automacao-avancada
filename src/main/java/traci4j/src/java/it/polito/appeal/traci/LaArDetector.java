    ...
    LaArDetector(
        ...
        addReadQuery(Variable.LANE,
                new ReadObjectVarQuery.LaneQ(dis, dos,
                        traci4j.src.java.it.polito.appeal.traci.protocol.Constants.CMD_GET_LANE_AREA_DETECTOR_VARIABLE
                        ,
                        id,
        ...
        addReadQuery(Variable.MEAN_SPEED,
                new ReadObjectVarQuery.DoubleQ(dis, dos,
                        ...
                        ,
                        id,
                        traci4j.src.java.it.polito.appeal.traci.protocol.Constants.LAST_STEP_MEAN_SPEED
        ...
        addReadQuery(Variable.VEHICLES,
                new VehicleSetQuery(dis, dos,
                        ...
                        ,
                        id,
                        traci4j.src.java.it.polito.appeal.traci.protocol.Constants.LAST_STEP_VEHICLE_ID_LIST
