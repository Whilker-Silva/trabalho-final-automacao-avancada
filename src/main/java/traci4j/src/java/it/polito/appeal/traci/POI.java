    ...
    POI(
        ...
        addReadQuery(Variable.TYPE,
                new ReadObjectVarQuery.StringQ(dis, dos,
                        traci4j.src.java.it.polito.appeal.traci.protocol.Constants.CMD_GET_POI_VARIABLE
                        ,
                        id,
        ...
        csqvar_ChangeColor = new ChangeColorQuery(dis, dos
                , traci4j.src.java.it.polito.appeal.traci.protocol.Constants.CMD_SET_POI_VARIABLE
