...
implements StepAdvanceListener
{
	...
	public static enum Variable {
		 ...
		 * @see #queryReadLastStepOccupancy
		 */
		LAST_STEP_OCCUPANCY,
		
		/** 
		 * Query "ReadMaxSpeed"
		 * @see #queryReadMaxSpeed
		 */
		MAX_SPEED,
		
		/** 
		 * Query "ReadParentEdge"
		 * @see #queryReadParentEdge
		 */
		PARENT_EDGE,
	...
	Lane (
		...
		addReadQuery(Variable.SHAPE, 
				new ReadShapeQuery (dis, dos,
						traci4j.src.java.it.polito.appeal.traci.protocol.Constants.CMD_GET_LANE_VARIABLE
	, 
				id,
						traci4j.src.java.it.polito.appeal.traci.protocol.Constants.VAR_SHAPE
	...
	, 
				id,
						traci4j.src.java.it.polito.appeal.traci.protocol.Constants.VAR_LENGTH
				
				));
		
		addReadQuery(Variable.WIDTH, 
				new ReadObjectVarQuery.DoubleQ (dis, dos,
						traci4j.src.java.it.polito.appeal.traci.protocol.Constants.CMD_GET_LANE_VARIABLE
	, 
				id,
						traci4j.src.java.it.polito.appeal.traci.protocol.Constants.VAR_WIDTH
	...
	, 
				id,
						traci4j.src.java.it.polito.appeal.traci.protocol.Constants.LAST_STEP_OCCUPANCY
	...
	, 
				id,
						traci4j.src.java.it.polito.appeal.traci.protocol.Constants.VAR_MAXSPEED
	...
	, 
				id,
						traci4j.src.java.it.polito.appeal.traci.protocol.Constants.LANE_EDGE_ID
				, repoEdge
	...
	, 
				id,
						traci4j.src.java.it.polito.appeal.traci.protocol.Constants.LANE_LINKS
				, repoLane
	...
	, 
				id,
						traci4j.src.java.it.polito.appeal.traci.protocol.Constants.LAST_STEP_VEHICLE_NUMBER
	 ...
	 * @return the instance of {@link ReadObjectVarQuery} relative to this query.
	 */
	public ReadObjectVarQuery<Double> queryReadWidth() {
		return (ReadObjectVarQuery.DoubleQ) getReadQuery(Variable.WIDTH);
	}
	 ...
	 * and returns the corresponding value.
	 */
	public Double getWidth() throws IOException {
		return ((ReadObjectVarQuery.DoubleQ) getReadQuery(Variable.WIDTH)).get();
	}
