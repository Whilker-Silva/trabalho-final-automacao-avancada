...
implements StepAdvanceListener
{
	...
	Edge (
		...
		addReadQuery(Variable.TRAVEL_TIME, 
				new ReadGlobalTravelTimeQuery (dis, dos,
						traci4j.src.java.it.polito.appeal.traci.protocol.Constants.CMD_GET_EDGE_VARIABLE
	, 
				id,
						traci4j.src.java.it.polito.appeal.traci.protocol.Constants.VAR_EDGE_TRAVELTIME
	...
	, 
		...
		csqvar_ChangeTravelTime = new ChangeGlobalTravelTimeQuery(dis, dos
