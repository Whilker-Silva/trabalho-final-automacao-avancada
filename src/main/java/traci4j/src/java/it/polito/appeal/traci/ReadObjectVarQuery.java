...
package traci4j.src.java.it.polito.appeal.traci;

import traci4j.src.java.de.uniluebeck.itm.tcpip.Storage;
...
import traci4j.src.java.it.polito.appeal.traci.protocol.StatusResponse;
import traci4j.src.java.it.polito.appeal.traci.protocol.StringList;
...
public abstract class ReadObjectVarQuery<V> extends ValueReadQuery<V> {
	...
	public static class BoundingBoxQ extends ReadObjectVarQuery<Rectangle2D> {
		...
		protected Rectangle2D readValue(Command resp) throws TraCIException {
			Storage content = resp.content();
			return new traci4j.src.java.it.polito.appeal.traci.protocol.BoundingBox(content, true);
		}
	}
